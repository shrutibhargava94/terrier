...
public class Indexing {
	...
	public static void main(String[] args) throws IOException {
		...
		String path_to_data = "C:\\Users\\z.fernando\\Documents\\terrier-4.0\\nyt\\data";
		String lang = "";
		...
		String indexPath = terrier_home+"/var/index/nyt/";
		...
		if(!new File(indexPath+prefix+".docid.map").exists()) {
			...
			index.terrier.prepareIndex(path_to_data, "txt", "en", false, true);
